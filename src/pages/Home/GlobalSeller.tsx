import globalSellerImg from "../../assets/images/gobalseller.jpg";

const GlobalSellerSection = () => {
  return (
    <section
      style={{ backgroundImage: `url(${globalSellerImg})` }}
      className={`bg-cover relative`}
    >
      <div className="py-8 container text-center px-4 background-image">
        <div className="relative bg-white md:left-0 p-6 md:p-8 rounded-none shadow-lg w-full max-w-md">
...
export default GlobalSellerSection;
